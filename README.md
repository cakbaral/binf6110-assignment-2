...
**Figure 1**: PCA plot of *S. cerivisiae* transcriptome data.  PC1 explained 67% of the variance, while PC2 explained 26% of the variance.  The replicates were clustered according to the developmental stages of Velum biofilm they were observed at, indicating mostly clear distinctions in profiles between groups. 
